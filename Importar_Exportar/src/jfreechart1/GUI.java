...
public class GUI extends javax.swing.JFrame {
 String []valores=null; // vector para guardar las palabras
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     try {
         ...
         File archivo = new File("informacion.csv");  // objeto que lee el archivo
         int i=0,Y=0;
         ...
         while(entrada.hasNext()){
             ...
             valores=linea.split(","); // toma los valores entre coma y coma y los guarda en string
             // System.out.println(" los valores de la primera linea son: "+ linea+" el primer valor guardado es: "+ valores[0]);
             modelo.setValueAt(valores[Y],i,0);
            i++;  
